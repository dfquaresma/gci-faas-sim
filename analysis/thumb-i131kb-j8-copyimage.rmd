...
source("functions.R")
gci = filter(read.al(paste("../experiment/results-131kb-j8-copyimage/", "gci1", ".csv", sep="")), status == 200)
nogci = filter(read.al(paste("../experiment/results-131kb-j8-copyimage/", "nogci1", ".csv", sep="")), status == 200)
