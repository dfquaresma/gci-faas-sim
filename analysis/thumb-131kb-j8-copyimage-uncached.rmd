...
source("functions.R")
gci = filter(read.al(paste("../experiment/instrumented-exps/results-131kb-j8-copyimage-uncached/", "gci1", ".csv", sep="")), status == 200)
nogci = filter(read.al(paste("../experiment/instrumented-exps/results-131kb-j8-copyimage-uncached/", "nogci1", ".csv", sep="")), status == 200)
