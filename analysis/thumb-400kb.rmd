...
source("functions.R")
gci   = filter(read.al(paste("../experiment/instrumented-exps/results-400kb/", "gci1", ".csv", sep="")), status == 200)
nogci = filter(read.al(paste("../experiment/instrumented-exps/results-400kb/", "nogci1", ".csv", sep="")), status == 200)
