...
source("functions.R")
gci = filter(read.al(paste("../experiment/results-131kb-j8/", "gci1", ".csv", sep="")), status == 200)
nogci = filter(read.al(paste("../experiment/results-131kb-j8/", "nogci1", ".csv", sep="")), status == 200)
