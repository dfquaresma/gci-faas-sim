...
source("functions.R")
sim_result_path = "../simulation/results0/"
...
pmin.y = 0.75
pmax.y = 0.999
print(paste(tecdf_nsched, "- 3-4 quantile", sep=" "))
graph_tail_sim(gci=gci_normscheduler,  nogci=nogci_normscheduler,
           tags= c("GCI", "NOGCI"),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
...
pmin.y = 0.75
pmax.y = 0.9999
print(paste(tecdf_opsched, "- 3-4 quantile", sep=" "))
graph_tail_sim(gci=gci_opscheduler,  nogci=nogci_opscheduler,
           tags= c("GCI", "NOGCI"),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
...
pmin.y = 0.75
pmax.y = 0.9999
print(paste(tecdf_opgcisched, "- 3-4 quantile", sep=" "))
graph_tail_sim(gci=gci_opgcischeduler,  nogci=nogci_opscheduler,
           tags= c("GCI", "NOGCI"),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y
