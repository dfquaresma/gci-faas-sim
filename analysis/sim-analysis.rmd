...
for(i in 1:4){
  ...
  nogc_normscheduler = rbind(nogci_normscheduler, readInput("sim-pp-nogc", "normscheduler", i))
  nogc_opscheduler   = rbind(nogci_opscheduler, readInput("sim-pp-nogc", "opscheduler", i))
  nogc_opgcischeduler  = rbind(gci_opgcischeduler, readInput("sim-pp-nogc", "opgcischeduler", i))
}
