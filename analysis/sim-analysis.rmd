...
tcit_nsched     = "TABELA 1: CONFIDENCE INTERVAL FOR RESPONSE TIME IN MS - NORM SCHEDULER"
print(tcit_nsched)
...
```{r  fig.width=15, fig.height=5, echo=FALSE, warning=FALSE}
tcit_opsched    = "TABELA 2: CONFIDENCE INTERVAL FOR RESPONSE TIME IN MS - OP SCHEDULER"
print(tcit_opsched)
...
```{r  fig.width=15, fig.height=5, echo=FALSE, warning=FALSE}
tcit_opgcisched = "TABELA 3: CONFIDENCE INTERVAL FOR RESPONSE TIME IN MS - OP GCI SCHEDULER"
print(tcit_opgcisched)
...
```{r  fig.width=15, fig.height=5, echo=FALSE, warning=FALSE}
tct_nsched     = "TABELA 1: COMPARISON TABLE FOR RESPONSE TIME IN MS - NORM SCHEDULER"
print(tct_nsched)
...
```{r  fig.width=15, fig.height=5, echo=FALSE, warning=FALSE}
tct_opsched    = "TABELA 2: COMPARISON TABLE FOR RESPONSE TIME IN MS - OP SCHEDULER"
print(tct_opsched)
...
```{r  fig.width=15, fig.height=5, echo=FALSE, warning=FALSE}
tct_opgcisched = "TABELA 3: COMPARISON TABLE FOR RESPONSE TIME IN MS - OP GCI SCHEDULER"
print(tct_opgcisched)
