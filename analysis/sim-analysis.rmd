...
print(tcit)
tags = c(
  "normsc.gci",  "normsc.nogci",
  "opsc.gci", "opsc.nogci",
  "opgcisc.gci", "opgcisc.nogci"
  )
summary_table_sim(
  gci_normscheduler,
  nogci_normscheduler,
...
graph_tail_sim(gci=gci_normscheduler,  nogci=nogci_normscheduler,
           tags= c("GCI", "NOGCI"), title=paste(tecdf_nsched, "- 0-4 quantile", sep=" "),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y, p999_instead_p9999=TRUE
)
pmin.x = min(qg[4], qng[4])
pmax.x = max(qg[8], qng[8])
pmin.y = 0.75
pmax.y = 0.999
graph_tail_sim(gci=gci_normscheduler,  nogci=nogci_normscheduler,
           tags= c("GCI", "NOGCI"), title=paste(tecdf_nsched, "- 3-4 quantile", sep=" "),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y, p999_instead_p9999=TRUE
)
```
...
graph_tail_sim(gci=gci_opscheduler,  nogci=nogci_opscheduler,
           tags= c("GCI", "NOGCI"), title=paste(tecdf_opsched, "- 0-4 quantile", sep=" "),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y
)
pmin.x = min(qg[4], qng[4])
pmax.x = max(qg[9], qng[9])
pmin.y = 0.75
pmax.y = 0.9999
graph_tail_sim(gci=gci_opscheduler,  nogci=nogci_opscheduler,
           tags= c("GCI", "NOGCI"), title=paste(tecdf_opsched, "- 3-4 quantile", sep=" "),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y
)
```
...
graph_tail_sim(gci=gci_opgcischeduler,  nogci=nogci_opscheduler,
           tags= c("GCI", "NOGCI"), title=paste(tecdf_opgcisched, "- 0-4 quantile", sep=" "),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y
)
pmin.x = min(qg[4], qng[4])
...
pmax.y = 0.9999
graph_tail_sim(gci=gci_opgcischeduler,  nogci=nogci_opscheduler,
           tags= c("GCI", "NOGCI"), title=paste(tecdf_opgcisched, "- 3-4 quantile", sep=" "),
           x_limit_inf=pmin.x, x_limit_sup=pmax.x,
           y_limit_inf=pmin.y, y_limit_sup=pmax.y
)
```
...
take_col_i <- function(i) {return (c(gci_normscheduler_met[i], gci_opscheduler_met[i], gci_opgcischeduler_met[i], nogci_normscheduler_met[i], nogci_opscheduler_met[i]))}
